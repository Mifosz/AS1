...
<form action="<?php print(_APP_ROOT); ?>/app/calc.php" method="post" class="pure-form pure-form-stacked">
	...
	<fieldset>
        ...
        <input id="id_op" type="text" name="op" value="7" readonly />
        <?php
        global $role;
        if($role == 'admin'){
            echo '<label for="id_op">Oprocentowanie Administratora </label>';
            echo '<input id="id_op" type="text" name="op" value="" />';
        }
        ?>
		<label for="id_y">Okres w latach </label>
